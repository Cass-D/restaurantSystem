 ...
 */
public class getWaiterOrder extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sql = "SELECT orderinfo.*,userinfo.userAccount FROM orderinfo,userinfo WHERE waiterId=userId AND orderState=0 AND waiterId="+id;
