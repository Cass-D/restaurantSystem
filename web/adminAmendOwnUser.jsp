...
<head>
    ...
    <script type="text/javascript">
        ...
        function check(form) {
            if (document.forms.amendUserForm.userPass2.value == "") {
                alert("请输入原密码");
                document.forms.amendUserForm.userPass2.focus();
                return false;
            }
            ...
            if (document.forms.amendUserForm.userPass2.value != userPass) {
                alert("原密码错误");
                document.forms.amendUserForm.userPass2.value = null;
                document.forms.amendUserForm.userPass2.focus();
                return false;
            }
        }
    ...
    <div class="row" style="padding-top: 0px">
        <div style="width: 50%;display: inline-block;">
            <div>
                ...
                <p>
                <form class="form-horizontal" role="form" style="margin-top: 20px" method="get"
                      action="/userUpDate" name="amendUserForm">
                    ...
                    <div class="form-group">
                        <label for="userPass" class="col-sm-2 control-label">原密码:</label>
                        <div class="col-sm-10">
                    ...
                    <input type="hidden" value="<%=faceimg%>" id="faceimg" name="faceimg"/>
                    <div class="form-group">
        ...
        <div style="width: 40%;display: inline-block;vertical-align: top;">
            ...
            <div style="text-align: center;">
                <img src=<%="img/"+faceimg%> id="face" width="200px" height="200px"
