...
function ajaxRequest(url, methodtype, contype, functionName, errorFunctionName) {
...
function ajaxRequest3(url, methodtype, contype, functionName, errorFunctionName) {
	// 获取XmlHttpRequest对象用以发送请求并获取结果
	var xmlhttp = getajaxHttp();
	// 请求回调
	xmlhttp.onreadystatechange = function() {
...
function ajaxRequest2(url, methodtype, contype) {
	// 获取XmlHttpRequest对象用以发送请求并获取结果
	var xmlhttp = getajaxHttp();
	var returned = null;
	// 请求回调
