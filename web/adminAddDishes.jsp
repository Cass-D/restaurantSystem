...
<head>
    ...
    <script type="text/javascript">
        ...
        function check(){
            ...
            if(document.forms.addDishesForm.dishesName.value==""){
                alert("请输入菜品名称！");
                document.forms.addDishesForm.dishesName.focus();
                return false;
            }

            if (ajaxRequest2("/checkDishes?dishesName="+document.forms.addDishesForm.dishesName.value, "post", false) == "true") {
                alert("该菜品已存在！");
                document.forms.addDishesForm.dishesName.focus();
                return false;
            }

            if(document.forms.addDishesForm.dishesName.value.length>20){
                alert("菜品名称不要超过20个字符！");
                document.forms.addDishesForm.dishesName.focus();
                return false;
            }
            if(document.forms.addDishesForm.dishesDiscript.value.length>200){
                alert("菜品简介不要超过200个字符！");
                document.forms.addDishesForm.dishesDiscript.focus();
                return false;
            }
            if(document.forms.addDishesForm.dishesTxt.value.length>400){
                alert("菜品说明不要超过400个字符！");
                document.forms.addDishesForm.dishesDiscript.focus();
                return false;
            }
            if(document.forms.addDishesForm.dishesPrice.value==""){
                alert("请输入价格！");
                document.forms.addDishesForm.dishesPrice.focus();
                return false;
            }
            if(!/^(-?\d+)(\.\d+)?$/.test(document.forms.addDishesForm.dishesPrice.value)){
        ...
        <div class="row" style="padding-top: 0px">
            <div style="width: 55%;display: inline-block;">
                <div>
                    ...
                    <form class="form-horizontal" name="addDishesForm" role="form" style="margin-top: 20px" method="post" action="/dishesInsert">
                        <icss:token></icss:token>
                        <div class="form-group">
                            <label for="dishesName" class="col-sm-2 control-label">名&nbsp;&nbsp;&nbsp;&nbsp;称:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="dishesName" size="20" name="dishesName" placeholder="请输入菜品名称" required >
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="dishesDiscript" name="dishesDiscript" placeholder="请输入少于100字的简介">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dishesTxt" class="col-sm-2 control-label">说&nbsp;&nbsp;&nbsp;&nbsp;明:</label>
                            <div class="col-sm-10">
                                <textarea rows="8" class="form-control" id="dishesTxt" name="dishesTxt"></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="dishesPrice" name="dishesPrice" placeholder="请输入菜品价格" onblur="checkprice()">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="checkbox" name="recommend" id="recommend" value="1" /> <span style="font-size: 16px;font-weight: bold;">推荐菜品</span>
                            </div>
                            <div style="color: red;float: right;" id="priceerror"></div>
                        </div>
                        <input type="hidden" value="userIcon.jpg" id="dishesImg" name="dishesImg" />
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <input type="submit" class="btn btn-primary" id="addbtu" value="添加菜品" onclick="return check()" />
                            </div>
                        </div>
                    </form>
                </div>
            </div>
            <div style="width: 5%;display: inline-block;padding-top: 0px;margin-top: 0px;vertical-align: top;padding-left: 30px">
            ...
            <div style="width: 25%;display: inline-block;vertical-align: top;">
                ...
                <div style="text-align: center;">
                    <img src="img/userIcon.jpg" id="face" width="160px" height="160px" class="img-circle" style="border:3px solid #CCC;" />
                    <p style="margin-top: 15px">当前菜品图像预览</p>
                    <p style="margin-top: 15px">
                        为菜品指定新的图片，请选择图片文件后，点击<span style="color: red;font-weight: bold;">上传图片</span>按钮
                    </p>
                    <div>
                        <form class="form-inline" role="form" id="myForm" enctype="multipart/form-data" action="<%=request.getContextPath()%>/servlet/UploadHandleServlet" name="imgform" target="submitform" method="post">
                            <div class="form-group">
