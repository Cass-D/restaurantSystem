...
<head>
    ...
    <script>
        ...
        function checkDelete(id, name, obj) {
            msg = '是否将'+ name +'离职？';
            if (confirm(msg)) {
                xmlAjaxRequest("/userStatus?id=" + id + "&locked=" + 1, "post", true, null, deleteCallback, obj, null);
            }
        }
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody id="orderTable">
                    <%
                        String sql = "SELECT userinfo.*,roleinfo.roleName FROM userinfo,roleinfo WHERE userinfo.roleId=roleinfo.roleId AND locked=0 AND roleinfo.roleId>"+roleId;
                    ...
                    %>
                    <tr>
                        <td class="tableCenter"><%=rs.getInt(1)%>
                        </td>
                        ...
                        <td class="tableCenter">
                            <a href="adminAmendUser.jsp?id=<%=rs.getInt(1)%>&userAccount=<%=rs.getString("userAccount")%>&userPass=<%=rs.getString("userPass")%>&faceimg=<%=rs.getString("faceimg")%>"
                               title="修改员工信息">
                            ...
                            <%--<a href="#" title="员工复职"><span class="glyphicon glyphicon-play"></span></a>--%>
                        </td>
                    </tr>
                    <%
                            }
