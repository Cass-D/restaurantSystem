        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody id="orderTable">
                    <%--<%--%>
                        <%--String sql = "SELECT dishesinfo.* FROM dishesinfo WHERE shelvesed=1";--%>
                    ...
                    <%--%>--%>
                    <%--<tr>--%>
                        <%--<td class="tableCenter"><%=rs.getInt("dishesId")%>--%>
                        <%--</td>--%>
                        <%--<td class="tableCenter"><%=rs.getString("dishesName")%>--%>
                        <%--</td>--%>
                        <%--<td class="tableCenter"><%=rs.getString("dishesDiscript")%>--%>
                        <%--</td>--%>
                        <%--<td class="tableCenter"><%=rs.getFloat("dishesPrice")%>--%>
                        <%--</td>--%>
                        <%--<td class="tableCenter"><%=rs.getInt("recommend") == 0 ? "非推荐" : "推荐"%>--%>
                        <%--</td>--%>
                        <%--<td class="tableCenter"><%=rs.getInt("shelvesed") == 0 ? "下架" : "上架"%>--%>
                        <%--</td>--%>
                        <%--<td class="tableCenter">--%>
                            <%--<a href="adminAmendDishes.jsp?id=<%=rs.getInt("dishesId")%>&name=<%=rs.getString("dishesName")%>&discript=<%=rs.getString("dishesDiscript")%>&txt=<%=rs.getString("dishesTxt")%>&price=<%=rs.getString("dishesPrice")%>&recommend=<%=rs.getInt("recommend")%>&dishesImg=<%=rs.getString("dishesImg")%>"--%>
                               <%--title="编辑菜品">--%>
                                <%--<span class="glyphicon glyphicon-cog"></span>--%>
                            <%--</a>--%>
                            <%--<a href="#" title="查看菜品"--%>
                               <%--onclick="detail('<%=rs.getString("dishesName")%>','<%=rs.getString("dishesDiscript")%>','<%=rs.getString("dishesTxt")%>','<%=rs.getFloat("dishesPrice")%>','<%=rs.getString("dishesImg")%>','<%=rs.getString("dishesType")%>')">--%>
                                <%--<span class="glyphicon glyphicon-list-alt"></span> &nbsp--%>
                            <%--</a>--%>
                            <%--<a href="#" title="下架菜品"--%>
                               <%--onclick="checkDelete('<%=rs.getInt("dishesId")%>','<%=rs.getString("dishesName")%>',this)">--%>
                                <%--<span class="glyphicon glyphicon-remove"></span> &nbsp--%>
                            <%--</a>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
